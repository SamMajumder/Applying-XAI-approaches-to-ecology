...
Rfe_best_subset <- read.csv("Datasets and Tables","Rfe_best_subset.csv")
...
Trait_data <- read.csv("Datasets and Tables","Trait_data.csv")
...
write.csv(Not_best_subset,"C:/Users/samba/Documents/Chapter_3_Traditional_ML_modeling/Datasets and Tables/Not_best_subset.csv",row.names = F)
